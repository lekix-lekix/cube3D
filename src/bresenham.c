...
/*   Updated: 2024/12/11 17:54:21 by kipouliq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int    draw_line_straight(t_position *start, t_position *end, int color, t_mlx_img *img)
{
    int inc;
    int x;
...
int draw_slope_horizontal(t_position *start, t_position *end, int color, t_mlx_img *img)
{
    int error;
    int error_inc;
    int x;
...
int draw_slope_vertical(t_position *start, t_position *end, int color, t_mlx_img *img)
{
    int error;
    int error_inc;
    int x;
...
int drawLine(t_position start, t_position end, int color, t_mlx_img *img)
{
	int dx;
	int dy;
	int inc_x;
